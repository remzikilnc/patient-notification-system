    ...
    return (
        <Fragment>
            <div className="flex justify-between pt-5">
                ...
                <UIButtonPrimary type="button" onClick={handleAddClick}>Add Contact</UIButtonPrimary>
            </div>
                ...
                <div className="inline-block min-w-full py-2 align-middle">
                    <div className="overflow-hidden rounded-md border border-passiveBorder">
                        ...
                        <thead className="bg-gray-100">
                            <tr>
                                <th scope="col"
                                    className="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-4 cursor-default">
                                    Name
                                </th>
