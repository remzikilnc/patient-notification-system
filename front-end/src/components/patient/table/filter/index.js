        ...
        <div className="flex flex-row justify-between gap-x-2">
            <div className="w-full max-w-2xl">
                ...
                <UIFormInputSearchWithIcon
                    ...
                    placeholder="Search"
                    handleChange={e => handleFilterChange("filter", "search", e.target.value)}
                />
            </div>
            <div className="rounded my-1 flex gap-x-2">
                <button onClick={resetFilters}>
                    <UIIconHasBackground
                        isActive={!(filters === modelsDefaultFilterValues)}
                        Icon={LuFilterX}
                        text={"Clear Filter"}
                    />
                </button>
                <Popover as="section" aria-labelledby="filter-heading">
                    ...
                    <Transition enter="transition ease-out duration-200"
                        ...
                        <Popover.Panel
                            className="my-2 absolute bg-white dark:bg-themeDarker dark:border-themeBorderGray border-gray-300 border-01 p-4 rounded shadow-2xl origin-top-right right-0">
                            <div className="flex flex-row flex-nowrap w-full mb-2 justify-between">
                                <span
                                    className="dark:text-themePassiveText text-gray-800 flex items-center text-sm">Filters</span>
                                <button onClick={resetFilters}>
                                ...
                                <div className="w-full grid gap-3 grid-cols-1 sm:grid-cols-2">
                                    <fieldset>
                                        ...
                                        <UIFormInputSearchWithIcon
                                            ...
                                            Icon={BsHash}
                                            placeholder="ID"
                                            handleChange={e => handleFilterChange("filter", "id", e.target.value)}
                                        >
                                            <UIButtonSortWithOptions defaultValue={filters.sort.id} field="id"
                                    ...
                                    <fieldset>
                                        ...
                                        <UIFormInputSearchWithIcon
                                            ...
                                            Icon={BiRename}
                                            placeholder="Title"
                                            handleChange={e => handleFilterChange("filter", "name", e.target.value)}
                                        >
                                            <UIButtonSortWithOptions
                                    ...
                                    <fieldset>
                                        ...
                                        >
                                            <UIButtonSortWithOptions
                                                defaultValue={filters.sort.surname}
                                                field="surname"
                                                handleSortChange={handleSortChange}
                                            />
                                        </UIFormInputSearchWithIcon>
