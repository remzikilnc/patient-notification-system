      ...
      <div className="flex rounded-md shadow-sm">
        <div id="search-container" className="relative flex flex-grow items-stretch z-20">
          ...
          <input
            ...
            className={`block w-full rounded border border-gray-300 bg-white py-2.5 pl-10 pr-3 text-xs placeholder-gray-500 focus:border-themeSecondary focus:text-themePassiveText focus:ring-0 focus:outline-none ${
