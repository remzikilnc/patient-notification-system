  ...
  return (
    <Combobox value={selectedValue} onChange={setSelectedValue}>
      ...
      <div className="relative">
        <ComboboxInput
          className={`block w-full rounded-md  ${options === "up" ? "rounded-t-none" : ""} border border-gray-300 bg-white py-2 px-3 text-sm placeholder-gray-500 focus:border-primary focus:text-passiveText focus:outline-none focus:ring-0 sm:text-sm`}
