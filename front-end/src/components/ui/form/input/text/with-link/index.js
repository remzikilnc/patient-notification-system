    ...
    return (
        <Fragment>
            <div className="flex">
                ...
                <input {...props} type={type} className={' border-gray-300 focus:border-primary focus:ring-themeSecondary' + `rounded rounded-l-none shadow-sm block w-full bg-white h-[40px] ${error ? 'border-red-600' : ''}` + className} />
            </div>
