...
export const LeftSidebar = ({children}) => {
    return (
        <aside className="hidden md:fixed md:inset-y-0 md:flex md:w-64 md:flex-col dark:bg-themeDarker bg-white">
            <div className="flex flex-grow flex-col border-r bg-primary dark:border-themeBorderGray rounded-r-2xl">
                ...
                <div className="flex px-4 flex-grow flex-col overflow-y-auto mt-2">
                    {children}
                </div>
            </div>
        </aside>
